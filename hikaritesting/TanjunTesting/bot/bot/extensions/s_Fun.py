...
@component.with_slash_command
@tanjun.with_str_slash_option("subreddits", "Choose wholesomememes, memes, dankmemes, or nothing for a random meme.", default=None, choices=['wholesomememes', 'memes', 'dankmemes'])
@tanjun.as_slash_command("meme", "Shows some memes!")
async def meme(ctx: tanjun.abc.Context, subreddits: str) -> None:        
...
@component.with_slash_command
@tanjun.as_slash_command("goats", "Shows a pic of some cute goats!")
async def goats(ctx: tanjun.abc.Context) -> None:
